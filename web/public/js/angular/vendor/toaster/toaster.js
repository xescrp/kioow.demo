    ...
    return {
        ...
        '<div  id="toast-container" ng-class="config.position">' +
            '<div ng-repeat="toaster in toasters" class="toast" ng-class="toaster.type" ng-click="click(toaster)" ng-mouseover="stopTimer(toaster)"  ng-mouseout="restartTimer(toaster)">' +
              '<div class="toast-icon padded-l text-center"><i class="fa"></i></div>' +
              '<div class="toast-body padded-l">' +
                '<strong ng-class="config.title">{{toaster.title}}</strong>' +
                '<div ng-class="config.message" class="marged-zero" ng-switch on="toaster.bodyOutputType">' +
                    '<div ng-switch-when="trustedHtml" ng-bind-html="toaster.html"></div>' +
                    '<div ng-switch-when="template"><div ng-include="toaster.bodyTemplate"></div></div>' +
                    '<div ng-switch-default >{{toaster.body}}</div>' +
                '</div>' +
                '<button class="toast-close-button" ng-show="config.closeButton"><span aria-hidden="true">&times;</span><span class="sr-only"></span></button>' +
                '<div/>' +
            '</div>' +
        '</div>'
        //'<div  id="toast-container" ng-class="config.position">' +
