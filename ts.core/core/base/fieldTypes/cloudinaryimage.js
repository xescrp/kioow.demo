...
cloudinaryimage.prototype.addToSchema = function () {
    ...
    var src = function (item, options) {
        ...
        //if (!('fetch_format' in options) && omtcore.get('cloudinary webp') !== false) {
        //    options.fetch_format = "auto";
        //}

        //if (!('progressive' in options) && omtcore.get('cloudinary progressive') !== false) {
        //    options.progressive = true;
        //}

        //if (!('secure' in options) && omtcore.get('cloudinary secure')) {
        //    options.secure = true;
        //}
...
//            var tp = omtcore.get('cloudinary prefix') || '';
...
//            if (omtcore.get('cloudinary prefix'))
//                uploadOptions.tags.push(omtcore.get('cloudinary prefix'));

//            if (omtcore.get('env') != 'production')
