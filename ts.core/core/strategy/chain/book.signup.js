module.exports = function (conf, callback) {
    console.log('booking - signup passenger or check traveler...[' + conf.bookingmodel + ']');
    conf.signuponbudget = false;
    ...
    cev.on('new.signup', function () {
        ...
        var firstroom = conf.roomdistribution != null && conf.roomdistribution.length > 0 ?
            conf.roomdistribution[0] : null;
        var pax = firstroom.paxlist != null && firstroom.paxlist.length > 0 ? firstroom.paxlist[0] : null;

        newsignup.name = pax != null ? pax.name : signup.name;
        newsignup.lastname = pax != null ? pax.lastname : signup.lastname;
        newsignup.email = newsignup.email || dummymail;
