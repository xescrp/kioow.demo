module.exports = function (conf, callback) {
    ...
    var validations = [
        ...
        function () { //signup is not empty
            var ok = conf.bookingmodel.indexOf('b2b') >= 0 ||
                (signup != null && !common.utils.stringIsNullOrEmpty(signup.email));
            (!ok) ? assert.messages.push('no signup detected, you must inform the info of the traveler for signup') : null;
            return ok;
        }
    ];
