...
module.exports = function (options, callback, errorcallback) {
    ...
    function databuilding(conf) {
        ...
        //finded
        coreobj.list('DMCProducts').model.find(query).count(function (err, total) {
        ...
        coreobj.list('DMCProducts').model.find(query).count(function (err, count) {
            if (err) { console.log(err); }
            finded = count;
        });
        //ready to query
        var querystream = coreobj.list('DMCProducts').model.find(query)
    ...
    function filterbuilding(conf) {
        ...
        coreobj.list('DMCProducts').model.find(query)
